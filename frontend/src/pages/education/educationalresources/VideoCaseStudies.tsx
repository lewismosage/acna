...
const caseStudyVideos: CaseStudyVideo[] = [
  {
    ...
    condition: "Epilepsy",
    description:
      "How community-based training reduced treatment gaps from 85% to 35% in rural communities",
  ...
  },
  {
    ...
    description:
      "Innovative mobile clinic program provides specialized neurological assessments in remote areas",
  ...
  },
  {
    ...
    description:
      "Real-time consultations connect rural health centers with pediatric neurologists",
  ...
  },
  {
    ...
    description:
      "Community education transforms attitudes and increases school enrollment for children with CP",
  ...
  },
  {
    ...
    description:
      "National developmental screening program improves early identification and intervention",
  ...
  },
  {
    ...
    description:
      "Comprehensive training creates network of skilled pediatric neurology practitioners",
