            ...
            <div className="lg:w-2/5">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-blue-600 text-white px-3 py-1 text-sm font-bold uppercase tracking-wide rounded">
                    {ebooklet.category}
                  </span>
                </div>
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                ...
                {/* Keywords */}
                {ebooklet.keywords && ebooklet.keywords.length > 0 && (
                  <div>
                ...
                {/* Tags */}
                {ebooklet.tags && ebooklet.tags.length > 0 && (
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{ebooklet.pages}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">File Size:</span>
                      <span className="font-medium">{ebooklet.fileSize}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Language:</span>
                      <span className="font-medium">{ebooklet.language}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {ebooklet.isbn && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{ebooklet.isbn}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                  <div className="p-6">
                    <ol className="space-y-3">
                      {ebooklet.tableOfContents.map((item, index) => (
                        <li key={index} className="flex items-start">
                          <span className="bg-red-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-4 flex-shrink-0 mt-1">
                            {index + 1}
                          </span>
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium">{ebooklet.title}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Pages:</span>
                        <div className="font-medium">{ebooklet.pages}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">File Size:</span>
                        <div className="font-medium">{ebooklet.fileSize}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Language:</span>
                        <div className="font-medium">{ebooklet.language}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Category:</span>
                        <div className="font-medium">{ebooklet.category}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Downloads:</span>
...
export default EBookletDetailPage;