...
const PublicationDetailPage = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'details' | 'authors' | 'download'>('overview');
    ...
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <div className="text-red-600 text-center">
          <h2 className="text-xl font-semibold mb-2">Error Loading Publication</h2>
          <p>{error}</p>
          <button
            ...
            <div className="lg:w-2/5">
              <div className="relative">
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-2">
                  ...
                  <span className={`px-3 py-1 text-sm font-bold rounded ${getAccessTypeColor(publication.accessType)}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="bg-gray-50 p-2 rounded">
                    <div className="text-lg font-bold text-red-600">{publication.downloads.toLocaleString()}</div>
                    <div className="text-xs text-gray-600">Downloads</div>
                  </div>
                  <div className="bg-gray-50 p-2 rounded">
                    <div className="text-lg font-bold text-red-600">{publication.viewCount.toLocaleString()}</div>
                    <div className="text-xs text-gray-600">Views</div>
                  </div>
                  <div className="bg-gray-50 p-2 rounded">
                    <div className="text-lg font-bold text-red-600">{publication.citationCount}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  {publication.externalUrl && (
                    <button 
                      onClick={() => window.open(publication.externalUrl, '_blank')}
                      className="border border-red-600 text-red-600 px-4 py-3 rounded hover:bg-red-50 transition-colors flex items-center"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                ...
                {publication.fullContent && (
                  <div>
                    <h2 className="text-2xl font-light text-gray-900 mb-4">Content</h2>
                    <div className="prose max-w-none">
                      <p className="text-gray-600 whitespace-pre-line leading-relaxed">
                        {publication.fullContent}
                      </p>
                ...
                {/* Target Audience */}
                {publication.targetAudience && publication.targetAudience.length > 0 && (
                  <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="text-lg font-light text-gray-900 mb-3">Publication Information</h3>
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-600">{publication.status}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Access:</span>
                      <span className="font-medium">{publication.accessType}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                {(publication.journal || publication.volume || publication.issue || publication.pages) && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {publication.volume && (
                        <div><span className="font-medium">Volume:</span> {publication.volume}</div>
                      )}
                      {publication.issue && (
                        <div><span className="font-medium">Issue:</span> {publication.issue}</div>
                      )}
                      {publication.pages && (
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <h3 className="text-lg font-light text-gray-900 mb-3">Statistics</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <Download className="w-4 h-4 mr-2 text-red-600" />
                      <span className="text-gray-600">Downloads:</span>
                      <span className="font-medium ml-1">{publication.downloads.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center">
                      <Eye className="w-4 h-4 mr-2 text-red-600" />
                      <span className="text-gray-600">Views:</span>
                      <span className="font-medium ml-1">{publication.viewCount.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center">
                      <Award className="w-4 h-4 mr-2 text-red-600" />
                      <span className="text-gray-600">Citations:</span>
                      <span className="font-medium ml-1">{publication.citationCount}</span>
                    </div>
                    <div className="flex items-center">
                      <Calendar className="w-4 h-4 mr-2 text-red-600" />
                      <span className="text-gray-600">Published:</span>
                      <span className="font-medium ml-1">{publication.date}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Comprehensive information about this publication including technical specifications and metadata.
                </p>
              </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <span className={`font-medium ${publication.isFeatured ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">{publication.viewCount.toLocaleString()}</div>
                    ...
                    <div className="text-center p-4 bg-yellow-50 rounded-lg">
                      <div className="text-2xl font-bold text-yellow-600">{publication.citationCount}</div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Publication Information</h4>
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div>Status: <span className="text-green-600 font-medium">{publication.status}</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              {publication.authors && publication.authors.length > 0 ? (
                    ...
                    <div key={index} className="bg-white border border-gray-200 rounded-lg p-6">
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                          ...
                          {author.credentials && (
                            <p className="text-red-600 font-medium text-sm mb-1">{author.credentials}</p>
                          )}
                          <p className="text-gray-600 mb-3">{author.affiliation}</p>
                          {author.email && (
                            <a 
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600">Author information not available.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'download' && (
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Access this publication through the available download options.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <span className="text-gray-600">Access:</span>
                        <div className="font-medium">{publication.accessType}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Language:</span>
                        <div className="font-medium">{publication.language}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Downloads:</span>
                        <div className="font-medium text-green-600">{publication.downloads.toLocaleString()}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Published:</span>
                        ...
                        <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600">Full publication for offline reading</div>
                            </div>
                          </div>
                          <button
                            onClick={handleDownload}
                        ...
                        <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600">Access publication on external site</div>
                            </div>
                          </div>
                          <button
                            onClick={() => window.open(publication.externalUrl, '_blank')}
                      ...
                      <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Print-friendly format</div>
                          </div>
                        </div>
                        <button
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="terms" className="ml-3 text-sm text-gray-700">
                        I agree to use this publication for academic and professional purposes in accordance with copyright laws and ACNA guidelines.
                      </label>
                    </div>
                  </div>
                  ...
                  {publication.downloadUrl && (
                    ...
                    >
                      ...
                      {isDownloading ? 'Downloading Publication...' : 'Download Publication'}
                    </button>
                  )}
                  ...
                  <div className="text-center text-sm text-gray-600">
                    ...
                    <p className="mt-1">
                      ...
                      <a href="mailto:publications@acna.org" className="text-red-600 hover:underline">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                Other publications in the {publication.category} category that might interest you.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {relatedPublications.map((relatedPublication) => (
                <div 
                  ...
                  onClick={() => window.location.href = `/publications/${relatedPublication.id}`}
                >
                  <div className="relative">
                    <img
                  ...
                  <div className="p-6">
                    <h3 className="text-lg font-bold text-gray-900 mb-2">{relatedPublication.title}</h3>
                    ...
                    <p className="text-gray-600 text-sm mb-4 line-clamp-3">{relatedPublication.excerpt}</p>
