...
const PatientCaregiverResources = () => {
  ...
  const supportGroups: SupportGroup[] = [
    {
      ...
      description:
        "Support group for families dealing with childhood epilepsy, offering emotional support, practical advice, and advocacy training.",
  ...
  const emergencyResources: EmergencyResource[] = [
    {
      ...
      description:
        "Immediate consultation with pediatric neurologists for urgent situations",
  ...
  const filteredResources = resources.filter((resource) => {
    ...
    const matchesCondition =
      selectedCondition === "all" || resource.condition === selectedCondition;
    const matchesSearch =
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 font-light max-w-3xl mx-auto mb-8">
            Comprehensive support and practical resources for families
            navigating pediatric neurological conditions across Africa.
          </p>
                  ...
                  ? filteredResources.map((resource) => (
                      ...
                      >
                        <div className="relative">
                          <img
                            src={
                              resource.imageUrl || "/api/placeholder/400/250"
                            }
                            alt={resource.title}
                        ...
                        <div className="p-6">
                          ...
                          <div className="text-xs text-gray-500 mb-4">
                            ...
                            {resource.ageGroup && (
                              <div>Age Group: {resource.ageGroup}</div>
                            )}
                            {resource.duration && (
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              onClick={() =>
                                navigate(
                                  `/patient-care-resources/${resource.id}`
                                )
                              }
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Connect with other families facing similar challenges. Our
            ...
            <div className="space-y-8">
              {supportGroups.map((group) => (
                <div
                  key={group.id}
                  className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200 border border-gray-200 p-6"
                >
                      ...
                      {group.id === 1 && (
                        <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-4 rounded-r-lg">
                          <p className="text-blue-800 text-sm">
                            <strong>Officially supported by:</strong> The East
                            African Child Neurology Association (EACNA)
                          </p>
                        </div>
                      )}
        ...
        {activeTab === "emergency" && (
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-red-600 mx-auto mb-6"></div>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Immediate support when you need it most. Our emergency resources
                provide 24/7 access to neurological expertise and crisis support
                across Africa.
              </p>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-red-700 mb-3">
                    ...
                    call your local emergency services immediately. These
                    resources are for urgent neurological consultations and
                    support, not life-threatening emergencies.
                  </p>
                  <div className="flex flex-wrap gap-4 text-sm">
                    <span className="font-medium">Emergency Numbers:</span>
                    <span>
                      Kenya: 999 | Nigeria: 199 | South Africa: 10177 | Egypt:
                      123
                    </span>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {emergencyResources.map((resource) => (
                <div
                  key={resource.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-200 p-6"
                >
      ...
      <section className="py-16 bg-orange-600">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Stay Connected with ACNA
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get the latest resources, support group updates, and important
            information about pediatric neurological care delivered directly to
            your inbox.
          </p>
          ...
          <form onSubmit={handleSubscribe} className="max-w-md mx-auto">
            ...
            <p className="text-sm text-orange-100 opacity-90">
              Join thousands of families receiving support and resources. You
