...
const PatientCareDetail = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const url =
        resource.type === "App" || resource.type === "Website"
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-3/5">
              ...
              {/* Rating */}
              {resource.rating && (
                <div className="mb-6">{renderStars(resource.rating)}</div>
              )}
                    ...
                    <div>
                      ...
                      resource.externalUrl.includes("youtu.be") ? (
                        ...
                        <div className="relative w-full h-0 pb-[56.25%] bg-black rounded-lg overflow-hidden shadow-lg">
                          <iframe
                            className="absolute top-0 left-0 w-full h-full"
                            src={resource.externalUrl.replace(
                              "vimeo.com/",
                      ...
                      ) : resource.externalUrl.includes("soundcloud.com") &&
                        resource.type === "Audio" ? (
                        ...
                        <div className="bg-black rounded-lg overflow-hidden shadow-lg">
                          {resource.type === "Video" ? (
                            <video
                              ...
                              poster={
                                resource.imageUrl || "/api/placeholder/800/450"
                              }
                              preload="metadata"
                              onError={(e) => {
                                const videoElement =
                                ...
                                const fallback =
                                  videoElement.nextElementSibling as HTMLElement;
                            ...
                            <div className="bg-gradient-to-r from-red-600 to-orange-600 p-6">
                              ...
                              <audio
                                ...
                                onError={(e) => {
                                  ...
                                  const fallback =
                                    audioElement.nextElementSibling as HTMLElement;
                                  if (fallback)
                          ...
                          >
                            ...
                            <p className="text-gray-300 mb-4">
                              This media format is not supported for direct
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Comprehensive information about this resource including
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <span
                        className={`font-medium ${
                          resource.isFree ? "text-green-600" : "text-red-600"
                        }`}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      {resource.lastReviewDate && (
                        <div>Last Reviewed: {resource.lastReviewDate}</div>
                      )}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      {resource.reviewedBy && (
                        <div>Reviewed by: {resource.reviewedBy}</div>
                      )}
                      <div>
                        Status:{" "}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  ...
                  <br />
                  Help us improve by providing your feedback after using this
                  resource.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                Other resources in the {resource.category} category that might
                interest you.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {relatedResources.map((relatedResource) => (
                <div
                  ...
                  onClick={() =>
                    navigate(`/patient-care-resources/${relatedResource.id}`)
                  }
                >
                  <div className="relative">
                    <img
                      src={
                        relatedResource.imageUrl || "/api/placeholder/400/250"
                      }
