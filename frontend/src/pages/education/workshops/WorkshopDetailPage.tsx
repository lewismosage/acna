...
const WorkshopDetailPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "instructor" | "logistics" | "registration"
  >("overview");
    ...
    try {
      ...
      if (response.payment_required) {
        ...
        try {
          ...
          const paymentResponse = await workshopsApi.createPaymentSession(
        ...
        // No payment required - registration successful
        setRegistrationStatus({
          type: "success",
          message:
            response.message ||
            `Registration successful! You have been registered for "${workshop.title}". You will receive a confirmation email shortly.`,
        });
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            {error || "The workshop you're looking for doesn't exist."}
          </p>
          <button
            onClick={() => navigate(-1)}
            ...
            <div className="lg:w-2/5">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <span
                    className={`px-3 py-1 text-sm font-bold uppercase tracking-wide rounded ${getStatusColor(
                      workshop.status
                    )}`}
                  >
                    {workshop.status}
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <p className="text-gray-700 leading-relaxed mb-6">
                        Our instructor brings extensive experience in pediatric
                        neurology and is dedicated to providing hands-on,
                        practical training that participants can immediately
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 mr-3 mt-0.5 text-blue-600 flex-shrink-0" />
                        <span className="text-gray-700">
                          Any relevant case materials (optional)
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-green-600">
                          {workshop.capacity - workshop.registered} of{" "}
                          {workshop.capacity}
                        </div>
                      </div>
                      {workshop.price && (
                  ...
                  <form onSubmit={handleRegistration} className="space-y-6">
                    ...
                    <button
                      ...
                      disabled={
                        isRegistering ||
                        workshop.capacity - workshop.registered <= 0
                      }
                    ...
                    <div className="text-center text-sm text-gray-600">
                      <p>
                        Secure registration • Confirmation email will be sent
                      </p>
                      <p className="mt-1">
