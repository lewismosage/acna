...
import { workshopsApi, WorkshopRegistration } from '../../../../services/workshopAPI';
...
const RegistrationsTab: React.FC<RegistrationsTabProps> = ({ workshops: initialWorkshops }) => {
  ...
  const handleDeleteRegistration = async (registrationId: number) => {
    ...
    try {
      await workshopsApi.deleteRegistration(registrationId);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-gray-600 text-sm mt-1">Manage attendee registrations for all workshops</p>
        </div>
                ...
                <tr key={registration.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{registration.organization || 'No organization'}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {registration.registeredAt ? formatDate(registration.registeredAt) : 'No date'}
                  </td>
        ...
        {registrations.length === 0 && !isLoading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">No attendees have registered for any workshops yet.</p>
          </div>
        )}
      </div>
    </div>
