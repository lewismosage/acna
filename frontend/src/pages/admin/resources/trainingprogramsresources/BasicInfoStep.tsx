...
const BasicInfoStep: React.FC<BasicInfoStepProps> = ({
  ...
  const programTypes: ProgramType[] = ["Conference", "Workshop", "Fellowship", "Online Course", "Masterclass"];
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-bold text-gray-900 mb-6">Basic Program Information</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <select
            value={formData.type}
            onChange={(e) => onInputChange("type", e.target.value as ProgramType)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Lead Instructor *</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <select
            ...
            onChange={(e) => onInputChange("format", e.target.value as ProgramFormat)}
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          >
          ...
          {audienceOptions.map((audience) => (
            <label key={audience} className="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
              <input
                ...
                onChange={(e) => {
                  if (e.target.checked) {
                    onInputChange("targetAudience", [...formData.targetAudience, audience]);
                  } else {
                    onInputChange("targetAudience", formData.targetAudience.filter(item => item !== audience));
                  }
                }}
