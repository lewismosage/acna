...
> = ({ resources: initialResources = [] }) => {
  const [resources, setResources] =
    useState<PatientResource[]>(initialResources);
  const [selectedTab, setSelectedTab] = useState<
    "all" | "published" | "draft" | "archived" | "under-review" | "analytics"
  >("all");
  ...
  const [analyticsData, setAnalyticsData] = useState<ResourceAnalytics | null>(
    null
  );
  ...
  const handleCreateResource = async (
    ...
    try {
      ...
      if (editingResource) {
        const updatedResource = await patientCareApi.update(
          editingResource.id,
          createData
        );
        setResources((prev) =>
      ...
      <div className="space-y-6">
        ...
        {analyticsData.resourcesByType && (
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(analyticsData.resourcesByType).map(
                ([type, count]) => (
        ...
        {analyticsData.resourcesByCondition && (
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {Object.entries(analyticsData.resourcesByCondition).map(
                ([condition, count]) => (
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage educational resources, guides, and support materials for
                families
              </p>
            </div>
          ...
          <nav className="flex space-x-8 overflow-x-auto">
            {[
              ...
              },
              {
                id: "under-review",
                label: "Under Review",
                count: resources.filter((r) => r.status === "Under Review")
                  .length,
              },
              {
                id: "archived",
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Comprehensive analytics and insights about your patient care
                  resources
                </p>
              </div>
              {analyticsData ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    Analytics data will appear once you have published resources
              ...
              {filteredResources.length > 0 ? (
                filteredResources.map((resource) => {
                  ...
                  const { truncated: truncatedDescription, hasMore } =
                    truncateToTwoSentences(resource.description);
                      ...
                      <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/4">
                          <div className="relative">
                            <img
                              src={
                                resource.imageUrl || "/api/placeholder/300/200"
                              }
                              alt={resource.title}
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center text-gray-600 text-sm">
                                    ...
                                    <span>
                                      {safeArrayJoin(resource.language, 2)}
                                    </span>
                                  </div>
                                  <div className="flex items-center text-gray-600 text-sm">
                            ...
                            >
                              <Star
                                className={`w-4 h-4 mr-2 ${
                                  resource.isFeatured ? "fill-current" : ""
                                }`}
                              />
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-4">
                    {selectedTab === "all"
                      ...
                      : `No resources in the ${selectedTab.replace(
                          "-",
                          " "
                        )} category.`}
                  </p>
