        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-200">
              ...
              <Link to="/membership" className="text-blue-600 font-medium hover:text-blue-700 inline-flex items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-200">
              ...
              <Link to="/news" className="text-blue-600 font-medium hover:text-blue-700 inline-flex items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-200">
              ...
              <Link to="/events" className="text-blue-600 font-medium hover:text-blue-700 inline-flex items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-200">
              ...
              <Link to="/awards" className="text-blue-600 font-medium hover:text-blue-700 inline-flex items-center">
