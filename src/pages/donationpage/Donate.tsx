    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-[420px] lg:h-[440px]">
        <div className="absolute inset-0 flex flex-col lg:flex-row w-full h-full">
          ...
          <div className="relative z-10 w-full lg:w-1/2 flex flex-col justify-center bg-gradient-to-r from-blue-900 to-blue-700 h-full px-4 sm:px-6 lg:px-12 py-12">
            ...
            <h1 className="text-4xl font-bold text-white mb-4 text-center lg:text-left">
              Support Child Neurology in Africa
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto lg:mx-0 text-center lg:text-left">
